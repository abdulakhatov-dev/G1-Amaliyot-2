...
export const jobs: IJob[] = [
  ...
  {
    id: "74bd",
    title: "Pearl Christensen",
    type: "Remote",
    location: "Non quo eiusmod a qu",
    description: "Asperiores mollit do",
    salary: "$50K - $60K",
    company: {
      name: "Mitchell Walker Associates",
      description: "Porro proident cumq",
      contactEmail: "jaxobafub@mailinator.com",
      contactPhone: "+1 (677) 473-3575",
    },
  },
];
